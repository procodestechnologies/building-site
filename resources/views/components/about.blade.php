                ...
                <div class="row g-5 align-items-center">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="about-item-image d-flex">
                            <img src="{{ asset('frontend/img/about.jpg')}}" class="img-1 img-fluid w-50"  alt="">
                            <img src="{{ asset('frontend/img/about-3.jpg')}}" class="img-2 img-fluid w-50"  alt="">
                            <div class="about-item-image-content">
                                <img src="{{ asset('frontend/img/about-1.png')}}" class="img-fluid w-100 h-100" style="object-fit: cover;" alt="">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-4">
                                        <div class="about-item-content-img">
                                            <img src="{{ asset('frontend/img/about-2.jpg')}}" class="img-fluid w-100" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
